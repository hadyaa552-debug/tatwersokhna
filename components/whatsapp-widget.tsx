  ...
  return (
    ...
    >
      <div className="relative">
        <div className="w-14 h-14 bg-[#25D366] hover:bg-[#20BA5A] rounded-full shadow-lg flex items-center justify-center transition-all duration-300">
          <svg viewBox="0 0 24 24" className="h-7 w-7 text-white fill-current" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className="absolute inset-0 bg-[#25D366] opacity-75 animate-ping rounded-full" />
      </div>
